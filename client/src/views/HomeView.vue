  ...
  <main>
    ...
    <section class="features container">
      <div class="feature-item">
        <span>🚚</span>
        <div><b>极速配送</b><small>全国包邮次日达</small></div>
      </div>
      <div class="feature-item">
        <span>✅</span>
        <div><b>正品保障</b><small>官方授权假一赔十</small></div>
      </div>
      <div class="feature-item">
        <span>🔄</span>
        <div><b>七天退换</b><small>无忧售后放心购</small></div>
      </div>
      <div class="feature-item">
        <span>💬</span>
        <div><b>专属客服</b><small>7×24 小时在线</small></div>
      </div>
    </section>
...
.slide-1 {
  background: linear-gradient(120deg, #ff7a59, #ffb347);
}
.slide-2 {
  background: linear-gradient(120deg, #4f8cff, #38d0ff);
}
.slide-3 {
  background: linear-gradient(120deg, #34c98e, #a8e063);
}
.banner-content {
  text-align: center;
  color: #fff;
